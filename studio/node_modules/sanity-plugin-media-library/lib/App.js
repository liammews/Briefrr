...
var App = function (_a) {
    ...
    react_1.useEffect(function () {
        ...
        if (sort === 'az') {
            newFilteredAssets.sort(function (a, b) {
                return (a.title || a.originalFilename).localeCompare(b.title || b.originalFilename) ? -1 : 1;
            });
        }
        if (sort === 'za') {
            newFilteredAssets.sort(function (a, b) {
    ...
    var tags = getUniqueFiltersWithActive(assets, activeTags, function (acc, _a) {
        var tags = _a.tags;
