  ...
  return (
    ...
    <Layout>
        ...
        <div className="w-full bg-teal-100 rounded-md shadow-sm px-4 py-36 mb-8 flex flex-col justify-center items-center relative">
            ...
            <div className="p-12 bg-teal-200 rounded-md">
            <h1 className="text-center mb-4 text-teal-800 text-5xl max-w-3xl">Identity creator pack!</h1>
        ...
        <h2 className="text-4xl mb-4">Whats Included?</h2>
