  ...
  return (
    ...
    <div className="h-xl overflow-hidden relative flex flex-col items-center w-full rounded-md bg-blue-500 shadow-md px-4 py-12 lg:py-40">
            ...
            <div className="w-full lg:mb-4 lg:max-w-3xl z-40 bg-opacity-90 rounded-lg">
                <h1 className="text-7xl lg:text-8xl text-green-200 mb-4 text-center font-caveat">Welcome!</h1>
                <h3 className="text-xl text-white font-normal mb-4 text-center">We are glad to have you. Now you're a fully fleded member of the Briefrr team. Why not get started on a brief?</h3>
            </div>

            <div className="flex flex-row z-40 space-x-4 items-center">
            <Link to="/inbox">
            ...
            <Link to="/">
            <button className="font-manrope mb-4 lg:mt-0 mt-4 px-5 py-3 border-4 border-green-200 text-white font-bold rounded-md shadow-md transition duration-500 ease-in-out transform hover:shadow-lg hover:-translate-y-1 hover:scale-105">
                Home
            </button>
            </Link>
            </div>
