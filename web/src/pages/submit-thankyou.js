  ...
  return (
    ...
    <div className="h-xl overflow-hidden relative flex flex-col items-center w-full rounded-md bg-blue-500 shadow-md px-4 py-12 lg:py-40">
            ...
            <div className="w-full lg:mb-4 lg:max-w-3xl z-40 bg-opacity-90 rounded-lg">
                <h1 className="text-7xl lg:text-8xl text-green-200 mb-4 text-center font-caveat">Congratulations!</h1>
                <h3 className="text-xl text-white font-normal mb-4 text-center">Thank you for submitting your work! We will take a look and get back to you. In the meantime, why not get started on your next brief?</h3>
            </div>
