...
const Hero = () => {
    return(
        <div className="overflow-hidden relative flex flex-col items-center w-full rounded-md bg-white dark:bg-darkgray-900 shadow-sm px-4 py-24 lg:py-40">
            ...
            <div className="w-full lg:mb-4 lg:max-w-4xl z-40 bg-opacity-90 rounded-lg">
                <h1 className="text-3xl lg:text-5xl text-black dark:text-darkgray-50 mb-4 text-center">Use realistic practice briefs <br className="hidden md:inline"/>to upgrade your design skills</h1>
                <h3 className="text-base lg:text-xl text-black dark:text-darkgray-50 font-normal mb-4 text-center">Support your learning, build your portfolio<br className="hidden lg:inline" /> or get out of your creative box.</h3>
            </div>
