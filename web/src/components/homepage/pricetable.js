...
<div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <p className="text-4xl font-semibold font-manrope mt-0 mb-2"><b className="text-lime-500">Free</b> Access</p>
            ...
            <div className="flex flex-col items-start space-y-4 mt-4">
                ...
                <div className="flex flex-row items-center space-x-4">
                    <div><p className="m-0 text-green-500"><FaCheckCircle  /></p></div>
                    <div><p className="m-0 text-gray-500">Access to our learn-zone (coming soon)</p></div>
                </div>
                <div className="flex flex-row items-center space-x-4">
                    <div><p className="m-0 text-gray-500"><FaCheckCircle  /></p></div>
                    <div><p className="m-0 text-gray-500">Exclusive premium briefs</p></div>
                </div>
                <div className="flex flex-row items-center space-x-4">
                    <div><p className="m-0 text-gray-500"><FaCheckCircle  /></p></div>
            ...
            <p className="z-10 text-4xl font-semibold font-manrope mt-0 mb-2"><b className="text-pink-500">Premium</b> brief packs</p>
            <p className="z-10 text-2xl font-semibold font-manrope text-gray-500 mt-0">Pay as you go.</p>

            <div className="flex flex-col items-start space-y-4 mt-4">
                
            <div><p className="z-10 m-0 text-gray-500 mt-0"><b className="text-black dark:text-white">Want to step up your learning?</b> <br /> With our premium brief packs you can get a tailored course of 3 new and exclusive briefs + full feedback and support from a experienced professional designer.</p></div>
                ...
                <div className="z-10 flex flex-row items-center space-x-4">
                    <div><p className="m-0 text-green-500"><FaCheckCircle  /></p></div>
                    <div><p className="m-0 text-gray-500">1-2-1 feedback from experienced professionals</p></div>
                </div>
