...
const SubHero = () => {
    return(
        ...
        <div className="flex relative flex-col w-full bg-white dark:bg-darkgray-900 rounded-md shadow-sm p-4 lg:p-10 mb-8 z-20">
        ...
        <div className="flex flex-row space-x-8"> 
          <div className="flex-shrink-0">
            <img className="h-20 w-20 rounded-full border-2 border-gray-50 shadow-sm"src="https://pbs.twimg.com/profile_images/1374152003396452352/vMw5JgtS_400x400.jpg"></img>
          </div>
          <div>
        ...
        <div className="flex flex-row space-x-8"> 
          <div className="flex-shrink-0">
            <img className="h-20 w-20 rounded-full border-2 border-gray-50 shadow-sm"src="https://pbs.twimg.com/profile_images/1370716691970265088/9Gsvrlr2_400x400.jpg"></img>
          </div>
          <div>
            <p className="text-sm text-gray-500 font-medium m-0 mb-1">Team Briefrr</p>
            <p className="text-xl font-manrope text-black font-bold m-0 mb-2">A todays tip!</p>
