...
const contactCard = () => {
  return (
            <div className="flex flex-col items-center w-full rounded-md bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-600 shadow-md p-10 lg:px-40 lg:py-20">
                ...
                <div class="text-gray-700 dark:text-gray-300 mb-6">
                    ...
                    <input class="w-full h-10 px-3 text-base placeholder-gray-300 border rounded-lg focus:shadow-outline" type="text" placeholder="Briefrr" name="resourcename"/>
                </div>

                <div class="text-gray-700 dark:text-gray-300 mb-6">
                    <label class="block mb-1" for="forms-labelOverInputCode">What's the link?</label>
                    <input class="w-full h-10 px-3 text-base placeholder-gray-300 border rounded-lg focus:shadow-outline" type="text" placeholder="briefrr.co" name="link"/>
                </div>

                <div class="text-gray-700 dark:text-gray-300 mb-6">
                <label class="block mb-1" for="forms-labelOverInputCode">Why do you love it?</label>
                <textarea name="message" class="w-full h-32 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" name="why"></textarea>
                </div>
